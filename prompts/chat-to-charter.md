...
1. `AGENTS.md` with the sections Technical stack, Hosting/infrastructure, General architecture and Planned commands — only what we explicitly decided, nothing invented.
